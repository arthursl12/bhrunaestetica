...
const services = [
  ...
  },
  {
    ...
    description: "Movimentos intensos que modelam o contorno corporal, auxiliando na redução de gordura localizada.",
    icon: Flame
  },
  {
    title: "Massoterapia",
    description: "Massagem terapêutica focada em relaxar a musculatura, aliviar dores e melhorar o bem-estar geral.",
    icon: Heart
  },
  {
    title: "Termoterapia",
...
const differentials = [
  ...
  },
  {
    ...
    description: "Atendimento na R. Lídia, 38 - Entrada lateral - Pirajá, BH.",
    icon: MapPin
  },
  {
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <span className="text-brand-900/70">Próximo à Estação São Gabriel</span>
              </div>
            </li>
          </ul>
        </FadeIn>
